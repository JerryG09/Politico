...
describe('API ENDPOINTS', () => {
  describe('POST', () => {
    it('should not return success ', (done) => {
    chai
        .request(app)
        .post('/api/v1/parties')
        .send({
          name: 'apc',
          hqAddress: 'kogi',
          logoUrl: 'https://yahoo.com/img.jpeg'
        })
        .end((err, res) => {
    ...
    it('should not return success for failure creation of political party', (done) => {
      chai
        .request(app)
        .post('/api/v1/parties')
        .send({
    ...
    it('should not return success for a failure creation of political party', (done) => {
      chai
        .request(app)
        .post('/api/v1/parties')
        .send({
